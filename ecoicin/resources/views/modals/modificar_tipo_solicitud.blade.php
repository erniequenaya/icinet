        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="login px-4 mx-auto mw-100">
                    <h5 class="text-center mb-4">Modificiar Tipo Soliciutd</h5>
                    <h5 class="text-center">"Nombre"</h5>
                    <form action="{{route('administracion')}}" method="get">
                      <fieldset class="form-group">
                        <label class="mb-2">Nombre Tipo: </label>
                        <input name="nombre_tipo_soliciutd" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required="">
                      </fieldset>
